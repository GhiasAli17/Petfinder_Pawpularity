...
def mixup_data(x, z, y, params):
    ...
    Args:
        x: The image tensor.
        z: The dense features tensor.
        y: The target labels tensor.
        params: The dictionary of parameters, including 'mixupalpha' and 'device'.

    Returns:
        A tuple of mixed inputs and original/mixed labels.
    """
    if params['mixupalpha'] > 0:
        lam = np.random.beta(params['mixupalpha'], params['mixupalpha'])
    else:
        lam = 1
...
def mixup_criterion(criterion, pred, y_a, y_b, lam):
    ...
    Args:
        ...
        y_b: The mixed labels.
        lam: The mixing factor.
